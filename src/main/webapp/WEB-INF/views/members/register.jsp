		...
		<div class="container-fluid" style="margin-top: 80px;">
			<form action="/members/register" method="post" class="was-validated">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="Enter password" name="name" required>
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="Enter password" name="tel">
				</div>
